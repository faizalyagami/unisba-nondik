        ...
        <div class="card-body">
            <form action="{{ route('student.update', [$student]) }}" method="post" name="student-form" id="student-form" class="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control form-control-sm @error('period')  is-invalid @enderror" name="period" id="period" placeholder="Tanggal Lahir" value="{{ $student->period }}">
                    @error('period')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
