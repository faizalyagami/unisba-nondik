	...
	<div class="navbar-wrapper  ">
		<div class="navbar-content scroll-div ">
			...
			<ul class="nav pcoded-inner-navbar ">
				...
				<!-- CETAK KARTU - MENU KHUSUS UNTUK USER LEVEL 3 -->
				@if(in_array($user->level, [3]))
				<li class="nav-item pcoded-menu-caption">
					<label>Cetak Kartu</label>
				</li>
				<li class="nav-item {{ $active == 'cetak-kartu' ? 'active' : '' }}">
					<a href="{{ route('students.kartu-sks', auth()->user()->student_id) }}" class="nav-link " target="_blank">
						<span class="pcoded-micon"><i class="feather icon-printer"></i></span>
						<span class="pcoded-mtext">Cetak Kartu</span>
					</a>
				</li>
				@endif
